...
/*#define MPIDI_CH4_SHMI_SIMPLE_YIELD_IN_SKIP*/
#ifdef MPIDI_CH4_SHMI_SIMPLE_YIELD_IN_SKIP
#define MPIDI_CH4_SHMI_SIMPLE_SKIP MPL_sched_yield()
#warning "MPIDI_CH4_SHMI_SIMPLE_SKIP is yield"
#else /* MPIDI_CH4_SHMI_SIMPLE_YIELD_IN_SKIP */
#define MPIDI_CH4_SHMI_SIMPLE_SKIP do {} while (0)
/*#warning "MPIDI_CH4_SHMI_SIMPLE_SKIP is do ...while" */
#endif /* MPIDI_CH4_SHMI_SIMPLE_YIELD_IN_SKIP */
...
#define MPIDI_CH4_SHMI_SIMPLE_Q_assert(a_) \
    do {/*nothing*/} while (0)
...
static inline void MPIDI_CH4_SHMI_SIMPLE_queue_init(MPIDI_CH4_SHMI_SIMPLE_queue_ptr_t qhead)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_MPIDI_CH4_SHMI_SIMPLE_QUEUE_INIT);
...
#else /* !defined(MPIDI_CH4_SHMI_SIMPLE_USE_LOCK_FREE_QUEUES) */
...
#endif /* !defined(MPIDI_CH4_SHMI_SIMPLE_USE_LOCK_FREE_QUEUES) */
