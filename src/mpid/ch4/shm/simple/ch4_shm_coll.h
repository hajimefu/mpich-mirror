...
static inline int MPIDI_CH4_SHM_barrier(MPID_Comm *comm_ptr, MPIR_Errflag_t *errflag)
{
    int mpi_errno;
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4_SHM_ibarrier(MPID_Comm *comm_ptr, MPI_Request * req)
{
    int mpi_errno;
