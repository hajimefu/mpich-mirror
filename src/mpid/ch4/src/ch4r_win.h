...
static inline int MPIDI_CH4R_win_fence(int massert, MPID_Win *win)
{
    ...
    MPIDI_CH4R_EPOCH_FENCE_CHECK();
    mpi_errno = MPIDI_CH4I_progress_win_fence(win);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    MPIDI_CH4R_EPOCH_FENCE_EVENT();
