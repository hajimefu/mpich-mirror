                             ...
                             int target_count, MPI_Datatype target_datatype, MPID_Win * win)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_PUT);
    mpi_errno = MPIDI_netmod_put(origin_addr, origin_count, origin_datatype,
                                 target_rank, target_disp, target_count, target_datatype, win);
    if (mpi_errno != MPI_SUCCESS) {
        MPIR_ERR_POP(mpi_errno);
    }
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_PUT);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                             ...
                             int target_count, MPI_Datatype target_datatype, MPID_Win * win)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_GET);
    mpi_errno = MPIDI_netmod_get(origin_addr, origin_count, origin_datatype,
                                 target_rank, target_disp, target_count, target_datatype, win);
    if (mpi_errno != MPI_SUCCESS) {
        MPIR_ERR_POP(mpi_errno);
    }
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_GET);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                                    ...
                                    MPI_Datatype target_datatype, MPI_Op op, MPID_Win * win)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_ACCUMULATE);
    mpi_errno = MPIDI_netmod_accumulate(origin_addr, origin_count, origin_datatype,
  ...
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_ACCUMULATE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                                          ...
                                          int target_rank, MPI_Aint target_disp, MPID_Win * win)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_COMPARE_AND_SWAP);
    mpi_errno = MPIDI_netmod_compare_and_swap(origin_addr, compare_addr, result_addr,
                                              datatype, target_rank, target_disp, win);
    if (mpi_errno != MPI_SUCCESS) {
        MPIR_ERR_POP(mpi_errno);
    }
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_COMPARE_AND_SWAP);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                                     ...
                                     MPI_Op op, MPID_Win * win, MPID_Request ** request)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_RACCUMULATE);
    mpi_errno = MPIDI_netmod_raccumulate(origin_addr, origin_count, origin_datatype,
                                         target_rank, target_disp, target_count,
  ...
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_RACCUMULATE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                                         ...
                                         MPI_Op op, MPID_Win * win, MPID_Request ** request)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_RGET_ACCUMULATE);
    mpi_errno = MPIDI_netmod_rget_accumulate(origin_addr, origin_count, origin_datatype,
  ...
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_RGET_ACCUMULATE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                                      ...
                                      MPI_Aint target_disp, MPI_Op op, MPID_Win * win)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_FETCH_AND_OP);
    mpi_errno = MPIDI_netmod_fetch_and_op(origin_addr, result_addr,
                                          datatype, target_rank, target_disp, op, win);
    if (mpi_errno != MPI_SUCCESS) {
        MPIR_ERR_POP(mpi_errno);
    }
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_FETCH_AND_OP);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                              ...
                              MPI_Datatype target_datatype, MPID_Win * win, MPID_Request ** request)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_RGET);
    mpi_errno = MPIDI_netmod_rget(origin_addr, origin_count, origin_datatype,
                                  target_rank, target_disp, target_count,
  ...
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_RGET);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                              ...
                              MPI_Datatype target_datatype, MPID_Win * win, MPID_Request ** request)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_RPUT);
    mpi_errno = MPIDI_netmod_rput(origin_addr, origin_count, origin_datatype,
                                  target_rank, target_disp, target_count,
                                  target_datatype, win, request);
    if (mpi_errno != MPI_SUCCESS) {
        MPIR_ERR_POP(mpi_errno);
  ...
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_RPUT);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
                                        ...
                                        MPI_Datatype target_datatype, MPI_Op op, MPID_Win * win)
{
    ...
    MPIDI_FUNC_ENTER(MPID_STATE_CH4_GET_ACCUMULATE);
    mpi_errno = MPIDI_netmod_get_accumulate(origin_addr, origin_count, origin_datatype,
                                            result_addr, result_count, result_datatype,
  ...
  fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4_GET_ACCUMULATE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
