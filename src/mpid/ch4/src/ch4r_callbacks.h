...
static inline int MPIDI_CH4U_ack_put(MPIR_Request * rreq)
{
    ...
    mpi_errno = MPIDI_NM_inject_am_hdr_reply(MPIDI_CH4U_win_to_context(MPIDI_CH4U_REQUEST(rreq, req->preq.win_ptr)),
                                                 MPIDI_CH4U_REQUEST(rreq, src_rank),
...
static inline int MPIDI_CH4U_ack_cswap(MPIR_Request * rreq)
{
    ...
    mpi_errno = MPIDI_NM_send_am_reply(MPIDI_CH4U_win_to_context(MPIDI_CH4U_REQUEST(rreq, req->creq.win_ptr)),
                                           MPIDI_CH4U_REQUEST(rreq, src_rank),
...
static inline int MPIDI_CH4U_ack_acc(MPIR_Request * rreq)
{
    ...
    mpi_errno = MPIDI_NM_inject_am_hdr_reply(MPIDI_CH4U_win_to_context(MPIDI_CH4U_REQUEST(rreq, req->areq.win_ptr)),
                                                 MPIDI_CH4U_REQUEST(rreq, src_rank),
...
static inline int MPIDI_CH4U_ack_get_acc(MPIR_Request * rreq)
{
    ...
    mpi_errno = MPIDI_NM_send_am_reply(MPIDI_CH4U_win_to_context(MPIDI_CH4U_REQUEST(rreq, req->areq.win_ptr)),
                                           MPIDI_CH4U_REQUEST(rreq, src_rank),
                                                          ...
                                                          cmpl_handler_fn, MPIR_Request ** req)
{
    ...
    mpi_errno = MPIDI_NM_send_am_reply(MPIDI_CH4U_get_context(MPIDI_CH4U_REQUEST(sreq, req->lreq).msg_tag),
