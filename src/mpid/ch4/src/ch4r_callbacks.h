...
static inline int MPIDI_CH4U_unexp_cmpl_handler(MPID_Request * rreq)
{
    ...
    if (MPIDI_CH4U_REQUEST(rreq, req->status) & MPIDI_CH4U_REQ_MATCHED) {
        ...
        /* MPIDI_CS_ENTER(); */
        if (root_comm)
            match_req = MPIDI_CH4U_dequeue_posted(msg_tag, &MPIDI_CH4U_COMM(root_comm, posted_list));
                                                  ...
                                                  cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *is_contig = dt_contig;
    ...
    MPIDI_CH4U_REQUEST(*req, req->creq.addr) = msg_hdr->addr + base;
                                                ...
                                                cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *data = p_data;
    ...
    MPIDI_CH4U_REQUEST(*req, req->areq.target_addr) = (void *) (msg_hdr->target_addr + base);
                                                ...
                                                cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *cmpl_handler_fn = MPIDI_CH4U_get_cmpl_handler;
    ...
    MPIDI_CH4U_REQUEST(rreq, req->greq.addr) = msg_hdr->addr + base;
