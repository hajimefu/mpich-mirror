...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_progress_cmpl_list
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDI_CH4R_progress_cmpl_list(void)
{
    MPID_Request *req;
    MPIDI_CH4R_req_t *curr, *tmp;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_check_cmpl_order
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_check_cmpl_order(MPID_Request *req,
                                              MPIDI_CH4_NM_am_completion_handler_fn cmpl_handler_fn)
{
    ...
    MPIDI_CH4R_REQUEST(req, req->cmpl_handler_fn) = (void *)cmpl_handler_fn;
    MPIDI_CH4R_REQUEST(req, req->request) = (uint64_t) req;
    /* MPIDI_CS_ENTER(); */
    MPL_DL_APPEND(MPIDI_CH4_Global.cmpl_list, req->dev.ch4.ch4r.req);
    /* MPIDI_CS_EXIT(); */
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_send_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_send_origin_cmpl_handler(MPID_Request * sreq)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_send_long_lmt_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_STATE_DECL(MPID_STATE_CH4R_SEND_LONG_LMT_TX_HANDLER);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_SEND_LONG_LMT_TX_HANDLER);
    dtype_release_if_not_builtin(MPIDI_CH4R_REQUEST(sreq, req->lreq).datatype);
    MPIDI_CH4I_am_request_complete(sreq);
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_SEND_LONG_LMT_TX_HANDLER);
    return mpi_errno;
}

#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_ssend_ack_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_ssend_ack_origin_cmpl_handler(MPID_Request * req)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_ack_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_put_ack_origin_cmpl_handler(MPID_Request * req)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_get_cmpl_handler(MPID_Request * req)
{
    ...
    if (MPIDI_CH4R_REQUEST(req, req->greq.n_iov) == 0) {
        mpi_errno = MPIDI_CH4_NM_send_am_reply(MPIDI_CH4R_REQUEST(req, req->greq.reply_token),
                                               MPIDI_CH4R_GET_ACK,
                                               &get_ack, sizeof(get_ack),
                                               (void *)MPIDI_CH4R_REQUEST(req, req->greq.addr),
                                               MPIDI_CH4R_REQUEST(req, req->greq.count),
                                               MPIDI_CH4R_REQUEST(req, req->greq.datatype),
                                               req);
        MPIDI_CH4I_am_request_complete(req);
    ...
    iov = (struct iovec *)MPIDI_CH4R_REQUEST(req, req->greq.dt_iov);
    ...
    MPL_free(MPIDI_CH4R_REQUEST(req, req->greq.dt_iov));
    MPIDI_CH4R_REQUEST(req, req->greq.dt_iov) = (void *)p_data;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_ack_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_acc_ack_origin_cmpl_handler(MPID_Request * req)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_acc_ack_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_get_acc_ack_origin_cmpl_handler(MPID_Request * req)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Win *win;
    ...
    MPL_free(MPIDI_CH4R_REQUEST(req, req->areq.data));

    win = (MPID_Win *)MPIDI_CH4R_REQUEST(req, req->areq.win_ptr);
    /* MPIDI_CS_ENTER(); */
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_cswap_ack_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_cswap_ack_origin_cmpl_handler(MPID_Request * req)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Win *win;
    ...
    MPL_free(MPIDI_CH4R_REQUEST(req, req->creq.data));
    win = (MPID_Win *)MPIDI_CH4R_REQUEST(req, req->creq.win_ptr);
    /* MPIDI_CS_ENTER(); */
    OPA_decr_int(&MPIDI_CH4R_WIN(win, outstanding_ops));
    /* MPIDI_CS_EXIT(); */
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_ack_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_get_ack_origin_cmpl_handler(MPID_Request * req)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Win *win;
    ...
    if (MPIDI_CH4R_REQUEST(req, req->greq.dt_iov)) {
        MPL_free(MPIDI_CH4R_REQUEST(req, req->greq.dt_iov));
    }
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_put_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_cswap_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_cswap_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_acc_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_data_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_put_data_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_data_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_acc_data_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_iov_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_put_iov_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_iov_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_acc_iov_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_origin_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_get_origin_cmpl_handler(MPID_Request * sreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_reply_ssend
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_reply_ssend(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS, c;
    MPIDI_CH4R_Ssend_ack_msg_t ack_msg;
    MPIDI_STATE_DECL(MPID_STATE_CH4U_REPLY_SSEND);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4U_REPLY_SSEND);
    MPIR_cc_incr(rreq->cc_ptr, &c);
    ack_msg.sreq_ptr = MPIDI_CH4R_REQUEST(rreq, req->rreq.peer_req_ptr);

    mpi_errno = MPIDI_CH4_NM_send_am_hdr_reply(MPIDI_CH4R_REQUEST(rreq, req->rreq.reply_token),
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_ack_put
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_ack_put(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_CH4R_put_ack_msg_t ack_msg;
    MPIDI_STATE_DECL(MPID_STATE_CH4U_ACK_PUT);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4U_ACK_PUT);

    ack_msg.preq_ptr = MPIDI_CH4R_REQUEST(rreq, req->preq.preq_ptr);
    mpi_errno = MPIDI_CH4_NM_inject_am_hdr_reply(MPIDI_CH4R_REQUEST(rreq, req->preq.reply_token),
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_ack_cswap
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_ack_cswap(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS, c;
    MPIDI_CH4R_cswap_ack_msg_t ack_msg;
    void *result_addr;
    size_t data_sz;
    ...
    MPIDI_Datatype_check_size(MPIDI_CH4R_REQUEST(rreq, req->creq.datatype), 1, data_sz);
    result_addr = ((char *)MPIDI_CH4R_REQUEST(rreq, req->creq.data)) + data_sz;

    MPIR_cc_incr(rreq->cc_ptr, &c);
    ack_msg.req_ptr = MPIDI_CH4R_REQUEST(rreq, req->creq.creq_ptr);

    mpi_errno = MPIDI_CH4_NM_send_am_reply(MPIDI_CH4R_REQUEST(rreq, req->creq.reply_token),
                                           MPIDI_CH4R_CSWAP_ACK,
                                           &ack_msg, sizeof(ack_msg),
                                           result_addr, 1,
                                           MPIDI_CH4R_REQUEST(rreq, req->creq.datatype),
                                           rreq);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
fn_exit:
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_ack_acc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_ack_acc(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_CH4R_acc_ack_msg_t ack_msg;
    MPID_Win *win;

    MPIDI_STATE_DECL(MPID_STATE_CH4U_ACK_ACC);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4U_ACK_ACC);

    ack_msg.req_ptr = MPIDI_CH4R_REQUEST(rreq, req->areq.req_ptr);
    mpi_errno = MPIDI_CH4_NM_inject_am_hdr_reply(MPIDI_CH4R_REQUEST(rreq, req->areq.reply_token),
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_ack_get_acc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_ack_get_acc(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS, c;
    MPIDI_CH4R_acc_ack_msg_t ack_msg;
    ...
    mpi_errno = MPIDI_CH4_NM_send_am_reply(MPIDI_CH4R_REQUEST(rreq, req->areq.reply_token),
                                           MPIDI_CH4R_GET_ACC_ACK,
                                           &ack_msg, sizeof(ack_msg),
                                           MPIDI_CH4R_REQUEST(rreq, req->areq.data),
                                           MPIDI_CH4R_REQUEST(rreq, req->areq.data_sz),
                                           MPI_BYTE, rreq);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
fn_exit:
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_unexp_mrecv_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_unexp_mrecv_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    uint64_t msg_tag;
    size_t message_sz;
    ...
    buf = MPIDI_CH4R_REQUEST(rreq, req->rreq.mrcv_buffer);
    count = MPIDI_CH4R_REQUEST(rreq, req->rreq.mrcv_count);
    datatype = MPIDI_CH4R_REQUEST(rreq, req->rreq.mrcv_datatype);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_unexp_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_unexp_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS, c;
    MPID_Comm *root_comm;
    ...
    /* MPIDI_CS_ENTER(); */
    if (MPIDI_CH4R_REQUEST(rreq, req->status) & MPIDI_CH4R_REQ_UNEXP_DQUED) {
        if (MPIDI_CH4R_REQUEST(rreq, req->status) & MPIDI_CH4R_REQ_UNEXP_CLAIMED) {
            MPIDI_CH4R_unexp_mrecv_cmpl_handler(rreq);
        }
        /* MPIDI_CS_EXIT(); */
        goto fn_exit;
    }
    ...
    if (MPIDI_CH4R_REQUEST(rreq, req->status) & MPIDI_CH4R_REQ_MATCHED) {
        match_req = (MPID_Request *) MPIDI_CH4R_REQUEST(rreq, req->rreq.match_req);
    } else {
        /* MPIDI_CS_ENTER(); */
        if (root_comm)
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_recv_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_recv_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    ...
    if (!MPIDI_CH4R_check_cmpl_order(rreq, MPIDI_CH4R_recv_cmpl_handler))
        return mpi_errno;

    if (MPIDI_CH4R_REQUEST(rreq, req->status) & MPIDI_CH4R_REQ_RCV_NON_CONTIG) {
        MPL_free(MPIDI_CH4R_REQUEST(rreq, req->iov));
    }

    if (MPIDI_CH4R_REQUEST(rreq, req->status) & MPIDI_CH4R_REQ_UNEXPECTED) {
        mpi_errno = MPIDI_CH4R_unexp_cmpl_handler(rreq);
        if (mpi_errno) MPIR_ERR_POP(mpi_errno);
        goto fn_exit;
    }
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_acc_ack_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_get_acc_ack_cmpl_handler(MPID_Request * areq)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Win *win;
    ...
    if (!MPIDI_CH4R_check_cmpl_order(areq, MPIDI_CH4R_get_acc_ack_cmpl_handler))
        return mpi_errno;

    if (MPIDI_CH4R_REQUEST(areq, req->status) & MPIDI_CH4R_REQ_RCV_NON_CONTIG) {
        MPL_free(MPIDI_CH4R_REQUEST(areq, req->iov));
    }

    win = (MPID_Win *) MPIDI_CH4R_REQUEST(areq, req->areq.win_ptr);
    /* MPIDI_CS_ENTER(); */
    OPA_decr_int(&MPIDI_CH4R_WIN(win, outstanding_ops));
    /* MPIDI_CS_EXIT(); */

    dtype_release_if_not_builtin(MPIDI_CH4R_REQUEST(areq, req->areq.result_datatype));
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_put_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Win *win;
    ...
    if (!MPIDI_CH4R_check_cmpl_order(rreq, MPIDI_CH4R_put_cmpl_handler))
        return mpi_errno;
    ...
    if (MPIDI_CH4R_REQUEST(rreq, req->preq.dt_iov)) {
        MPL_free(MPIDI_CH4R_REQUEST(rreq, req->preq.dt_iov));
    }

    mpi_errno = MPIDI_CH4R_ack_put(rreq);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_iov_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_put_iov_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_CH4R_put_iov_ack_msg_t ack_msg;

    MPIDI_STATE_DECL(MPID_STATE_CH4R_PUT_IOV_CMPL_HANDLER);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_PUT_IOV_CMPL_HANDLER);

    ack_msg.origin_preq_ptr = (uint64_t) MPIDI_CH4R_REQUEST(rreq, req->preq.preq_ptr);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_iov_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_acc_iov_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_CH4R_acc_iov_ack_msg_t ack_msg;

    MPIDI_STATE_DECL(MPID_STATE_CH4R_ACC_IOV_CMPL_HANDLER);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_ACC_IOV_CMPL_HANDLER);

    ack_msg.origin_preq_ptr = (uint64_t) MPIDI_CH4R_REQUEST(rreq, req->areq.req_ptr);
    ack_msg.target_preq_ptr = (uint64_t) rreq;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_cswap_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_cswap_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    void *compare_addr;
    void *origin_addr;
    ...
    if (!MPIDI_CH4R_check_cmpl_order(rreq, MPIDI_CH4R_cswap_cmpl_handler))
        return mpi_errno;

    MPIDI_Datatype_check_size(MPIDI_CH4R_REQUEST(rreq, req->creq.datatype), 1, data_sz);
    origin_addr = MPIDI_CH4R_REQUEST(rreq, req->creq.data);
    compare_addr = ((char *)MPIDI_CH4R_REQUEST(rreq, req->creq.data)) + data_sz;

    /* MPIDI_CS_ENTER(); */

    if (MPIR_Compare_equal((void *)MPIDI_CH4R_REQUEST(rreq, req->creq.addr), compare_addr,
                           MPIDI_CH4R_REQUEST(rreq, req->creq.datatype))) {
        MPIU_Memcpy(compare_addr, (void *)MPIDI_CH4R_REQUEST(rreq, req->creq.addr), data_sz);
        MPIU_Memcpy((void *)MPIDI_CH4R_REQUEST(rreq, req->creq.addr), origin_addr, data_sz);
    } else {
        MPIU_Memcpy(compare_addr, (void *)MPIDI_CH4R_REQUEST(rreq, req->creq.addr), data_sz);
    }
    ...
    mpi_errno = MPIDI_CH4R_ack_cswap(rreq);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    MPIDI_CH4I_am_request_complete(rreq);
    MPIDI_CH4R_progress_cmpl_list();
fn_exit:
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_do_accumulate_op
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_do_accumulate_op(void *source_buf, int source_count, MPI_Datatype source_dtp,
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_handle_acc_cmpl
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_handle_acc_cmpl(MPID_Request * rreq, int do_get)
{
    ...
    MPID_Datatype_get_size_macro(MPIDI_CH4R_REQUEST(rreq, req->areq.target_datatype), basic_sz);
    data_sz = MPIDI_CH4R_REQUEST(rreq, req->areq.data_sz);
    ...
    if (MPIDI_CH4R_REQUEST(rreq, req->areq.op) == MPI_NO_OP) {
        MPIDI_CH4R_REQUEST(rreq, req->areq.origin_count) =
            MPIDI_CH4R_REQUEST(rreq, req->areq.target_count);
        MPIDI_CH4R_REQUEST(rreq, req->areq.data_sz) = data_sz;
    }

    if (MPIDI_CH4R_REQUEST(rreq, req->areq.dt_iov) == NULL) {

        if (original) {
            MPIU_Memcpy(original, MPIDI_CH4R_REQUEST(rreq, req->areq.target_addr),
                        basic_sz * MPIDI_CH4R_REQUEST(rreq, req->areq.target_count));
        }

        mpi_errno = MPIDI_CH4R_do_accumulate_op(MPIDI_CH4R_REQUEST(rreq, req->areq.data),
                                                MPIDI_CH4R_REQUEST(rreq, req->areq.origin_count),
                                                MPIDI_CH4R_REQUEST(rreq, req->areq.origin_datatype),
                                                MPIDI_CH4R_REQUEST(rreq, req->areq.target_addr),
                                                MPIDI_CH4R_REQUEST(rreq, req->areq.target_count),
                                                MPIDI_CH4R_REQUEST(rreq, req->areq.target_datatype), 0,
                                                MPIDI_CH4R_REQUEST(rreq, req->areq.op));
        if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    } else {
        iov = (struct iovec *)MPIDI_CH4R_REQUEST(rreq, req->areq.dt_iov);
        src_ptr = (char *)MPIDI_CH4R_REQUEST(rreq, req->areq.data);
        for (i = 0; i < MPIDI_CH4R_REQUEST(rreq, req->areq.n_iov); i++) {
            ...
            mpi_errno = MPIDI_CH4R_do_accumulate_op(src_ptr, count,
                                                    MPIDI_CH4R_REQUEST(rreq, req->areq.origin_datatype),
    ...
    /* MPIDI_CS_EXIT(); */
    if (MPIDI_CH4R_REQUEST(rreq, req->areq.data))
        MPL_free(MPIDI_CH4R_REQUEST(rreq, req->areq.data));

    if (original) {
        MPIDI_CH4R_REQUEST(rreq, req->areq.data) = original;
        mpi_errno = MPIDI_CH4R_ack_get_acc(rreq);
        if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    } else {
        MPIDI_CH4R_REQUEST(rreq, req->areq.data) = NULL;
        mpi_errno = MPIDI_CH4R_ack_acc(rreq);
        if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    }
    MPIDI_CH4I_am_request_complete(rreq);
fn_exit:
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_acc_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_STATE_DECL(MPID_STATE_CH4R_ACC_HANDLER);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_ACC_HANDLER);

    if (!MPIDI_CH4R_check_cmpl_order(rreq, MPIDI_CH4R_acc_cmpl_handler))
        return mpi_errno;

    mpi_errno = MPIDI_CH4R_handle_acc_cmpl(rreq, 0);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_acc_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_get_acc_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_STATE_DECL(MPID_STATE_CH4R_GET_ACC_HANDLER);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_GET_ACC_HANDLER);

    if (!MPIDI_CH4R_check_cmpl_order(rreq, MPIDI_CH4R_get_acc_cmpl_handler))
        return mpi_errno;

    mpi_errno = MPIDI_CH4R_handle_acc_cmpl(rreq, 1);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_ack_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_get_ack_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Request *greq;
    MPID_Win *win;
    ...
    if (!MPIDI_CH4R_check_cmpl_order(rreq, MPIDI_CH4R_get_ack_cmpl_handler))
        return mpi_errno;

    greq = (MPID_Request *) MPIDI_CH4R_REQUEST(rreq, req->greq.greq_ptr);
    if (MPIDI_CH4R_REQUEST(greq, req->status) & MPIDI_CH4R_REQ_RCV_NON_CONTIG) {
        MPL_free(MPIDI_CH4R_REQUEST(greq, req->iov));
    }

    win = (MPID_Win *) MPIDI_CH4R_REQUEST(greq, req->greq.win_ptr);
    /* MPIDI_CS_ENTER(); */
    OPA_decr_int(&MPIDI_CH4R_WIN(win, outstanding_ops));
    /* MPIDI_CS_EXIT(); */
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_cswap_ack_cmpl_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_cswap_ack_cmpl_handler(MPID_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Win *win;
    ...
    if (!MPIDI_CH4R_check_cmpl_order(rreq, MPIDI_CH4R_cswap_ack_cmpl_handler))
        return mpi_errno;

    win = (MPID_Win *) MPIDI_CH4R_REQUEST(rreq, req->creq.win_ptr);
    /* MPIDI_CS_ENTER(); */
    OPA_decr_int(&MPIDI_CH4R_WIN(win, outstanding_ops));
    /* MPIDI_CS_EXIT(); */

    MPL_free(MPIDI_CH4R_REQUEST(rreq, req->creq.data));
    MPIDI_CH4I_am_request_complete(rreq);
...
static inline int MPIDI_CH4I_do_send_target_handler(uint64_t reply_token,
                                                    void **data,
                                                    size_t * p_data_sz,
                                                    int *is_contig,
                                                    MPIDI_CH4_NM_am_completion_handler_fn *cmpl_handler_fn,
                                                    MPID_Request *rreq)
{
    ...
    *cmpl_handler_fn = MPIDI_CH4R_recv_cmpl_handler;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_send_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                 ...
                                                 MPID_Request ** req)
{
    ...
    if (rreq == NULL) {
        ...
        rreq->kind = MPID_REQUEST_RECV;
        MPIDI_CH4R_REQUEST(rreq, buffer) = (char *) MPL_malloc(*p_data_sz);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_send_long_req_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                          ...
                                                          MPID_Request ** req)
{
    ...
    MPID_Comm *root_comm;
    MPIDI_CH4R_Hdr_t *hdr = (MPIDI_CH4R_Hdr_t *) am_hdr;
    MPIDI_CH4R_Send_long_req_msg_t *lreq_hdr = (MPIDI_CH4R_Send_long_req_msg_t *) am_hdr;
    int context_id;
    ...
    if (rreq == NULL) {
        ...
        MPIDI_CH4R_REQUEST(rreq, buffer) = NULL;
        MPIDI_CH4R_REQUEST(rreq, datatype) = MPI_BYTE;
        MPIDI_CH4R_REQUEST(rreq, count) = lreq_hdr->data_sz;
        MPIDI_CH4R_REQUEST(rreq, tag) = hdr->msg_tag;
        MPIDI_CH4R_REQUEST(rreq, req->status) |= MPIDI_CH4R_REQ_LONG_RTS;
        MPIDI_CH4R_REQUEST(rreq, req->rreq.peer_req_ptr) = lreq_hdr->sreq_ptr;
        MPIDI_CH4R_REQUEST(rreq, req->rreq.reply_token)  = reply_token;
...
fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_SEND_LONG_REQ_HANDLER);
    return mpi_errno;
fn_fail:
    goto fn_exit;
}
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_send_long_lmt_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                          ...
                                                          MPID_Request ** req)
{
    int mpi_errno;
    MPID_Request *rreq;
    MPIDI_CH4R_Send_long_lmt_msg_t *lmt_hdr = (MPIDI_CH4R_Send_long_lmt_msg_t *) am_hdr;
    ...
    *req = rreq;
    ...
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_SEND_LONG_LMT_HANDLER);

    return mpi_errno;
}

#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_ssend_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                  ...
                                                  cmpl_handler_fn, MPID_Request ** req)
{
    ...
    MPIDI_CH4R_Ssend_req_msg_t *msg_hdr = (MPIDI_CH4R_Ssend_req_msg_t *) am_hdr;
    ...
    MPIU_Assert(req);
    MPIDI_CH4R_REQUEST(*req, req->rreq.peer_req_ptr) = msg_hdr->sreq_ptr;
    MPIDI_CH4R_REQUEST(*req, req->rreq.reply_token) = reply_token;
    MPIDI_CH4R_REQUEST(*req, req->status) |= MPIDI_CH4R_REQ_PEER_SSEND;
fn_exit:
                                                      ...
                                                      cmpl_handler_fn, MPID_Request ** req)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Request *sreq;
    MPIDI_CH4R_Ssend_ack_msg_t *msg_hdr = (MPIDI_CH4R_Ssend_ack_msg_t *) am_hdr;
                                                          ...
                                                          cmpl_handler_fn, MPID_Request ** req)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Request *sreq;
    MPIDI_CH4R_Send_long_ack_msg_t *msg_hdr = (MPIDI_CH4R_Send_long_ack_msg_t *) am_hdr;
    MPIDI_CH4R_Send_long_lmt_msg_t send_hdr;
    MPIDI_STATE_DECL(MPID_STATE_CH4R_SEND_LONG_ACK_HANDLER);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_SEND_LONG_ACK_HANDLER);
    ...
    mpi_errno = MPIDI_CH4_NM_send_am_reply(reply_token, MPIDI_CH4R_SEND_LONG_LMT,
                                           &send_hdr, sizeof(send_hdr),
                                           MPIDI_CH4R_REQUEST(sreq, req->lreq).src_buf,
                                           MPIDI_CH4R_REQUEST(sreq, req->lreq).count,
                                           MPIDI_CH4R_REQUEST(sreq, req->lreq).datatype,
                                           sreq);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);

    if (cmpl_handler_fn)
        *cmpl_handler_fn = MPIDI_CH4R_send_origin_cmpl_handler;

    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_SEND_LONG_ACK_HANDLER);
...
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_CH4R_put_ack_msg_t *msg_hdr = (MPIDI_CH4R_put_ack_msg_t *) am_hdr;
    MPID_Win *win;
    MPID_Request *preq;
    ...
    win = (MPID_Win *) MPIDI_CH4R_REQUEST(preq, req->preq.win_ptr);

    if (MPIDI_CH4R_REQUEST(preq, req->preq.dt_iov)) {
        MPL_free(MPIDI_CH4R_REQUEST(preq, req->preq.dt_iov));
    }
...
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_CH4R_acc_ack_msg_t *msg_hdr = (MPIDI_CH4R_acc_ack_msg_t *) am_hdr;
    MPID_Win *win;
    MPID_Request *areq;
    ...
    if (MPIDI_CH4R_REQUEST(areq, req->areq.dt_iov)) {
        MPL_free(MPIDI_CH4R_REQUEST(areq, req->areq.dt_iov));
    }
                                                        ...
                                                        cmpl_handler_fn, MPID_Request ** req)
{
    ...
    MPIDI_Datatype_get_info(MPIDI_CH4R_REQUEST(areq, req->areq.result_count),
    ...
    *is_contig = dt_contig;
    ...
    if (dt_contig) {
        ...
        *p_data_sz = n_iov;
        MPIDI_CH4R_REQUEST(areq, req->status) |= MPIDI_CH4R_REQ_RCV_NON_CONTIG;
        MPL_free(segment_ptr);
    }

    *req = areq;
    *cmpl_handler_fn = MPIDI_CH4R_get_acc_ack_cmpl_handler;
    MPIDI_CH4R_REQUEST(areq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);
...
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_CH4R_cswap_ack_msg_t *msg_hdr = (MPIDI_CH4R_cswap_ack_msg_t *) am_hdr;
    MPID_Request *creq;
    uint64_t data_sz;
    ...
    MPIDI_Datatype_check_size(MPIDI_CH4R_REQUEST(creq, req->creq.datatype), 1, data_sz);
    *data = MPIDI_CH4R_REQUEST(creq, req->creq.result_addr);
    *p_data_sz = data_sz;
    *is_contig = 1;

    *req = creq;
    *cmpl_handler_fn = MPIDI_CH4R_cswap_ack_cmpl_handler;
    MPIDI_CH4R_REQUEST(creq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_win_lock_advance
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDI_CH4R_win_lock_advance(MPID_Win *win)
{
    int mpi_errno = MPI_SUCCESS;
    struct MPIDI_CH4R_win_sync_lock *slock = &MPIDI_CH4R_WIN(win, sync).lock;
    struct MPIDI_CH4R_win_queue *q     = &slock->local.requested;

    MPIDI_STATE_DECL(MPID_STATE_CH4R_WIN_LOCK_ADVANCE);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_WIN_LOCK_ADVANCE);
    ...
    if( (q->head != NULL) && ((slock->local.count == 0) ||
        ...
        if(lock->mtype == MPIDI_CH4R_WIN_LOCK)
            msg.type = MPIDI_CH4R_WIN_LOCK_ACK;
        ...
        mpi_errno = MPIDI_CH4R_win_lock_advance(win);
        if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    }

fn_exit:
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_WIN_LOCK_ADVANCE);
    return mpi_errno;
fn_fail:
    goto fn_exit;
}
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_win_lock_req_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                ...
                                                uint64_t                    reply_token)
{
    ...
    struct MPIDI_CH4R_win_lock *lock = (struct MPIDI_CH4R_win_lock *)
        MPL_calloc(1, sizeof(struct MPIDI_CH4R_win_lock));

    if(info->type == MPIDI_CH4R_WIN_LOCK)
        lock->mtype = MPIDI_CH4R_WIN_LOCK;
    else if(info->type == MPIDI_CH4R_WIN_LOCKALL)
        lock->mtype = MPIDI_CH4R_WIN_LOCKALL;
    ...
    MPIDI_CH4R_win_lock_advance(win);
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_WIN_LOCK_REQ_PROC);
    return;
}

#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_win_lock_ack_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                ...
                                                MPID_Win                   *win)
{
    ...
    if(info->type == MPIDI_CH4R_WIN_LOCK_ACK)
        MPIDI_CH4R_WIN(win, sync).lock.remote.locked += 1;
    else  if(info->type == MPIDI_CH4R_WIN_LOCKALL_ACK)
        MPIDI_CH4R_WIN(win, sync).lock.remote.allLocked += 1;

    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_WIN_LOCK_ACK_PROC);
}

#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_win_unlock_ack_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                              ...
                                              uint64_t                    reply_token)
{
    ...
    int mpi_errno = MPI_SUCCESS;
    MPIDI_STATE_DECL(MPID_STATE_CH4R_WIN_UNLOCK_ACK_PROC);
    MPIDI_FUNC_ENTER(MPID_STATE_CH4R_WIN_UNLOCK_ACK_PROC);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_win_complete_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                ...
                                                MPID_Win                   *win)
{
    ...
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_WIN_COMPLETE_PROC);
}

#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_win_post_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                            ...
                                            MPID_Win                   *win)
{
    ...
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_WIN_POST_PROC);
}


#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_win_unlock_done_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                 ...
                                                 MPID_Win                   *win)
{
    ...
    MPIDI_FUNC_EXIT(MPID_STATE_CH4R_WIN_UNLOCK_DONE_CB);
}
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                ...
                                                cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *req = rreq;
    ...
    MPIDI_CH4R_REQUEST(*req, req->preq.preq_ptr) = msg_hdr->preq_ptr;
    MPIDI_CH4R_REQUEST(*req, req->preq.reply_token) = reply_token;
    ...
    /* MPIDI_CS_EXIT(); */
    MPIDI_CH4R_REQUEST(rreq, req->preq.win_ptr) = (uint64_t) win;

    *cmpl_handler_fn = MPIDI_CH4R_put_cmpl_handler;
    MPIDI_CH4R_REQUEST(rreq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);
    ...
    MPIDI_CH4R_REQUEST(rreq, req->preq.dt_iov) = NULL;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_iov_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_iov_ack_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                        ...
                                                        cmpl_handler_fn, MPID_Request ** req)
{
    ...
    MPIDI_CH4R_put_iov_ack_msg_t *msg_hdr = (MPIDI_CH4R_put_iov_ack_msg_t *) am_hdr;
    MPIDI_CH4R_put_dat_msg_t dat_msg;
    ...
    mpi_errno = MPIDI_CH4_NM_send_am_reply(reply_token,
                                           MPIDI_CH4R_PUT_DAT_REQ,
                                           &dat_msg, sizeof(dat_msg),
                                           MPIDI_CH4R_REQUEST(origin_req, req->preq.origin_addr),
                                           MPIDI_CH4R_REQUEST(origin_req, req->preq.origin_count),
                                           MPIDI_CH4R_REQUEST(origin_req, req->preq.origin_datatype),
                                           rreq);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    dtype_release_if_not_builtin(MPIDI_CH4R_REQUEST(origin_req, req->preq.origin_datatype));
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_iov_ack_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                        ...
                                                        cmpl_handler_fn, MPID_Request ** req)
{
    int mpi_errno = MPI_SUCCESS;
    MPID_Request *rreq, *origin_req;
    MPIDI_CH4R_acc_iov_ack_msg_t *msg_hdr = (MPIDI_CH4R_acc_iov_ack_msg_t *) am_hdr;
    MPIDI_CH4R_acc_dat_msg_t dat_msg;
    ...
    mpi_errno = MPIDI_CH4_NM_send_am_reply(reply_token,
                                           ...
                                           &dat_msg, sizeof(dat_msg),
                                           MPIDI_CH4R_REQUEST(origin_req, req->areq.origin_addr),
                                           MPIDI_CH4R_REQUEST(origin_req, req->areq.origin_count),
                                           MPIDI_CH4R_REQUEST(origin_req, req->areq.origin_datatype),
                                           rreq);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
    dtype_release_if_not_builtin(MPIDI_CH4R_REQUEST(origin_req, req->areq.origin_datatype));
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_put_data_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                     ...
                                                     cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *is_contig = 0;
    *p_data_sz = MPIDI_CH4R_REQUEST(rreq, req->preq.n_iov);
    *req = rreq;
    *cmpl_handler_fn = MPIDI_CH4R_put_cmpl_handler;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_data_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                     ...
                                                     cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *p_data_sz = data_sz;
    *req = rreq;
    *cmpl_handler_fn = MPIDI_CH4R_REQUEST(rreq, req->areq.do_get) ?
        MPIDI_CH4R_get_acc_cmpl_handler : MPIDI_CH4R_acc_cmpl_handler;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_cswap_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                  ...
                                                  cmpl_handler_fn, MPID_Request ** req)
{
    ...
    MPIDI_CH4R_cswap_req_msg_t *msg_hdr = (MPIDI_CH4R_cswap_req_msg_t *) am_hdr;
    ...
    *cmpl_handler_fn = MPIDI_CH4R_cswap_cmpl_handler;
    MPIDI_CH4R_REQUEST(rreq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);
    ...
    *is_contig = dt_contig;
    ...
    MPIDI_CH4R_REQUEST(*req, req->creq.win_ptr) = (uint64_t) win;
    ...
    *p_data_sz = data_sz * 2;
    *data = p_data;
    MPIDI_CH4R_REQUEST(*req, req->creq.data) = p_data;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_handle_acc_request
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                ...
                                                cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *cmpl_handler_fn = (msg_hdr->do_get) ? MPIDI_CH4R_get_acc_cmpl_handler :
        MPIDI_CH4R_acc_cmpl_handler;
    MPIDI_CH4R_REQUEST(rreq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);
    ...
    *data = p_data;
    ...
    MPIDI_CH4R_REQUEST(*req, req->areq.win_ptr) = (uint64_t) win;
    MPIDI_CH4R_REQUEST(*req, req->areq.req_ptr) = msg_hdr->req_ptr;
    MPIDI_CH4R_REQUEST(*req, req->areq.reply_token) = reply_token;
    MPIDI_CH4R_REQUEST(*req, req->areq.origin_datatype) = msg_hdr->origin_datatype;
    ...
    if (!msg_hdr->n_iov) {
        MPIDI_CH4R_REQUEST(rreq, req->areq.dt_iov) = NULL;
        goto fn_exit;
    }
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_acc_iov_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                    ...
                                                    cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *req = rreq;
    ...
    MPIDI_CH4R_REQUEST(*req, req->areq.n_iov) = msg_hdr->n_iov;
    MPIDI_CH4R_REQUEST(*req, req->areq.data_sz) = msg_hdr->result_data_sz;
    MPIDI_CH4R_REQUEST(*req, req->areq.do_get) = msg_hdr->do_get;
    ...
    *cmpl_handler_fn = MPIDI_CH4R_acc_iov_cmpl_handler;
    MPIDI_CH4R_REQUEST(rreq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                ...
                                                cmpl_handler_fn, MPID_Request ** req)
{
    ...
    *cmpl_handler_fn = MPIDI_CH4R_get_cmpl_handler;
    ...
    MPIDI_CH4R_REQUEST(rreq, req->greq.greq_ptr) = msg_hdr->greq_ptr;
    MPIDI_CH4R_REQUEST(rreq, req->greq.reply_token) = reply_token;
    ...
    if (msg_hdr->n_iov) {
        ...
        *p_data_sz = msg_hdr->n_iov * sizeof(*iov);
        MPIDI_CH4R_REQUEST(rreq, req->greq.dt_iov) = iov;
    }
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4R_get_ack_target_handler
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                    ...
                                                    cmpl_handler_fn, MPID_Request ** req)
{
    ...
    MPIDI_CH4R_get_ack_msg_t *msg_hdr = (MPIDI_CH4R_get_ack_msg_t *) am_hdr;
    ...
    *req = greq;
    ...
    MPIDI_CH4R_REQUEST(greq, req->greq.greq_ptr) = (uint64_t) rreq;

    if (MPIDI_CH4R_REQUEST(rreq, req->greq.dt_iov)) {
        MPL_free(MPIDI_CH4R_REQUEST(rreq, req->greq.dt_iov));
    }

    *cmpl_handler_fn = MPIDI_CH4R_get_ack_cmpl_handler;
    MPIDI_CH4R_REQUEST(greq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);

    MPIDI_Datatype_get_info(MPIDI_CH4R_REQUEST(rreq, req->greq.count),
