                                    ...
                                    void      **netmod_contexts)
{
    ...
    *tag_ub = (1<<MPID_TAG_SHIFT)-1;
    ...
    for(i=0; i<size; i++) {
        ...
        MPIU_STR_RC(MPIU_Str_get_binary_arg(valS,"OFI",(char *)&table[i*MPIDI_Global.addrnamelen],
    ...
    MPIDI_Global.control_req   = (MPIDI_Ctrl_req *) MPIU_Malloc(sizeof(MPIDI_Ctrl_req)*MPIDI_Global.num_ctrlblock);
