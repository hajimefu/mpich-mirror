                                         ...
                                         MPIR_Request ** request, int have_request)
{
    ...
    ucp_request = (MPIDI_UCX_ucp_request_t*) ucp_tag_send_sync_nb(ep, buf, data_sz, ucp_dt_make_contig(1),
                                     ucx_tag, &MPIDI_UCX_Handle_send_callback);
                                         ...
                                         MPIR_Datatype *datatype)
{
    ...
    ucp_request = (MPIDI_UCX_ucp_request_t*) ucp_tag_send_sync_nb(ep, buf, count, datatype->dev.netmod.ucx.ucp_datatype,
                                     ucx_tag, &MPIDI_UCX_Handle_send_callback);
                           ...
                           int have_request)
{
    ...
    if (dt_contig)
        mpi_errno =
            ucx_sync_send_continous(buf + dt_true_lb, data_sz, rank, tag, comm, context_offset, request,
                               have_request);
    else
         mpi_errno =
